    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h4>(<?php echo $proje['Proje']['id']; ?>) Proje Düzenle</h4>
            </div>
            <div class="ibox-content">
                <form class="form-horizontal" id="form-proje">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Başlık:</label>
                        <div class="col-lg-10"><input type="text" name="baslik" placeholder="Başlık" class="form-control" value="<?php echo $proje['Proje']['baslik']; ?>"></div>
                    </div>
...
//                                                echo '</li>';
                    ...
                    <input type="hidden" name="projeId" value="<?php echo $proje['Proje']['id']; ?>" />
                </form>
            </div>
        </div>
    </div>
