...
<div class="row padding-tb-5">
    ...
    <div class="col-xs-4 padding-rl-5">
        <div class="bg-danger padding-tb-5 text-center menu3">
...
<div class="row padding-tb-5">
    <div class="col-xs-4 padding-rl-5">
        <div class="bg-kurumsal padding-tb-5 text-center menu3">
    ...
    <div class="col-xs-4 padding-rl-5">
        <div class="bg-analiz padding-tb-5 text-center menu3">
...
<div class="row padding-tb-5">
    <div class="col-xs-4 padding-rl-5">
        <div class="bg-info padding-tb-5 text-center menu3">
