...
<?php echo $this->Form->create('Ilan'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ilan'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ilan.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Ilan.id')))); ?></li>
