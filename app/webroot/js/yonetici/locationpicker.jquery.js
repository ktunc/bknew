...
//                mapTypeId: google.maps.MapTypeId.ROADMAP,
            ...
            // rightclick yapinca marker'i tasiyor ve haritanin merkezini ayarliyor
            google.maps.event.addListener(gmapContext.map, "rightclick", function (event) {
                ...
                setTimeout(function(){gmapContext.map.setCenter(event.latLng);},600);
            });
            // doubleclick yapinca marker'i tasiyor ve haritanin merkezini ayarliyor
            google.maps.event.addListener(gmapContext.map, "dblclick", function (event) {
                gmapContext.marker.setPosition(event.latLng);
                GmUtility.setPosition(gmapContext, gmapContext.marker.position, function(context){
                    var currentLocation = GmUtility.locationFromLatLng(gmapContext.location);
                    context.settings.onchanged(currentLocation, context.radius, true);
